...
export default function CommentBox({
  ...
  const handleReferenceClick = () => {
    ...
    setActiveHighlight({
      ...
      document_kind: comment.document_kind ?? null,
      document_page: comment.document_page ?? null,
      document_anchor: comment.document_anchor ?? null,
      document_fingerprint: comment.document_fingerprint ?? null,
